...
const routes: Routes = [
  ...
  {
    path: 'listaprurales/:PRU01CODI',
    loadChildren: () => import('./listaprurales/listaprurales.module').then(m => m.ListapruralesPageModule)
  },
  {
    path: 'informacionPr',
    loadChildren: () => import('./informacion-pr/informacion-pr.module').then(m => m.InformacionPRPageModule)
  },
  {
    path: 'informacionPr/:PRU01CODI',
    loadChildren: () => import('./informacion-pr/informacion-pr.module').then(m => m.InformacionPRPageModule)
  },
  {
    path: 'infraestructuraPr',
    loadChildren: () => import('./infraestructura-pr/infraestructura-pr.module').then( m => m.InfraestructuraPRPageModule)
  },
  {
    path: 'infraestructuraPr/:PRU01CODI',
    loadChildren: () => import('./infraestructura-pr/infraestructura-pr.module').then( m => m.InfraestructuraPRPageModule)
  },
  {
    path: 'contruccion-r',
